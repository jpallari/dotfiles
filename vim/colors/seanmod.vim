" A variant of Sean Catchpole's sean color scheme.
...
" General colors
hi Cursor       ctermfg=NONE ctermbg=246  cterm=none guifg=NONE    guibg=#ffcc22 gui=none
hi Normal       ctermfg=253  ctermbg=NONE cterm=none guifg=#FFFAFA guibg=#111111 gui=none
hi NonText      ctermfg=238  ctermbg=NONE cterm=none guifg=#111111 guibg=#080808 gui=none
hi LineNr       ctermfg=239  ctermbg=16   cterm=none guifg=#857B6F guibg=#080808 gui=none
hi StatusLine   ctermfg=231  ctermbg=4    cterm=bold guifg=#FFFAFA guibg=#3045D8 gui=none
hi StatusLineNC ctermfg=243  ctermbg=17   cterm=none guifg=#857B6F guibg=#1025B8 gui=none
...
" Syntax highlighting
hi Comment      ctermfg=245  guifg=#99968B gui=none
hi Todo         ctermfg=247  ctermbg=NONE  cterm=bold guifg=#8F8F8F guibg=NONE gui=bold
