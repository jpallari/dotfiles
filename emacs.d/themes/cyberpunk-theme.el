...
(let ((class '((class color) (min-colors 89)))
 ...
 (custom-theme-set-faces
   ...
   `(term-color-red ((t (:foreground ,cyberpunk-red))))
   `(term-color-green ((t (:foreground ,cyberpunk-green))))
   `(term-color-yellow ((t (:foreground ,cyberpunk-yellow))))
   `(term-color-blue ((t (:foreground ,cyberpunk-blue))))
   `(term-color-magenta ((t (:foreground ,cyberpunk-magenta))))
   `(term-color-cyan ((t (:foreground ,cyberpunk-cyan))))
   `(term-color-white ((t (:foreground ,cyberpunk-white))))
   `(term-default-fg-color ((t (:foreground ,cyberpunk-fg))))
   `(term-default-color-black ((t (:foreground ,cyberpunk-bg))))
   )
