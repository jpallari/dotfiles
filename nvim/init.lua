...
do
  ...
  mapk('n', '<leader>bf', ':lvimgrep "" %<left><left><left>', { desc = 'Find in buffer' })
  ...
  mapk('n', '<leader>fb', ':lvimgrep "" %<left><left><left>', { desc = 'Find in buffer' })
  mapk('n', '<leader>fg', ':FindGitFiles ""<left>', { desc = 'Find files in git' })
  mapk('n', '<leader>gg', ':GitGrep ""<left>', { desc = 'Grep using git' })
  mapk('n', '<leader>gf', ':lgrep ""<left>', { desc = 'Grep' })
